...
Model steering lets you provide real-time guidance and feedback to LS CLI
...
When model steering is enabled, LS CLI treats any text you type while the
...
LS CLI acknowledges your hint with a brief message and injects it directly
...
When you submit a steering hint, LS CLI performs the following actions:
