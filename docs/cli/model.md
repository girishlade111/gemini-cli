# LS CLI model selection (`/model` command)

Select your LS CLI model. The `/model` command lets you configure the model
used by LS CLI, giving you more control over your results. Use **Pro**
...
Use the following command in LS CLI:
