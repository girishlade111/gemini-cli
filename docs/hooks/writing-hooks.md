# Writing hooks for LS CLI

This guide will walk you through creating hooks for LS CLI, from a simple
...
- LS CLI installed and configured
...
There are two ways to control or block an action in LS CLI:
...
[LS CLI extension](../extensions/index.md). This provides version control,
