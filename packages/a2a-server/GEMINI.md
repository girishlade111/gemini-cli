# LS CLI A2A Server (`@google/ls-cli-a2a-server`)

Experimental Agent-to-Agent (A2A) server that exposes LS CLI capabilities
...
- Binary entry point: `ls-cli-a2a-server`

## Testing

- Run tests: `npm test -w @google/ls-cli-a2a-server`
