# RFC: LS CLI A2A Development-Tool Extension

## 1. Introduction

### 1.1 Overview

To standardize client integrations with the LS CLI agent, this document
...
required for rich, interactive workflows with the LS CLI agent.

### 1.2 Motivation

Recent work integrating LS CLI with clients like Zed and Gemini Code
...
- **Ecosystem Alignment**: Aligns LS CLI with a growing industry standard,
...
workflows between a client and the LS CLI agent. It consists of a
...
```json
{
  ...
  "capabilities": {
    ...
    "extensions": [
      {
        "uri": "https://github.com/google-gemini/ls-cli/blob/main/docs/a2a/developer-profile/v0/spec.md",
...
// Configuration settings for the LS CLI agent.
