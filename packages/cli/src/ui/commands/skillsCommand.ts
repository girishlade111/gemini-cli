...
import { getAdminErrorMessage, getErrorMessage } from '@google/ls-cli-core';
import {
  linkSkill,
...
export const skillsCommand: SlashCommand = {
  name: 'skills',
  description:
    'List, enable, disable, or reload LS CLI agent skills. Usage: /skills [list | disable <name> | enable <name> | reload]',
