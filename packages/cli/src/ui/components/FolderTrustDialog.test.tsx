...
import { makeFakeConfig, ExitCodes } from '@google/ls-cli-core';
...
describe('FolderTrustDialog', () => {
  ...
  it('should render the dialog with title and description', async () => {
    ...
    expect(lastFrame()).toContain(
      'Trusting a folder allows LS CLI to load its local configurations',
    );
    unmount();
  });
  ...
  it('should display restart message when isRestarting is true', async () => {
    ...
    expect(lastFrame()).toContain('LS CLI is restarting');
    unmount();
  });
