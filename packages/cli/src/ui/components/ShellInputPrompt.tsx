...
import { ShellExecutionService } from '@google/ls-cli-core';
...
export const ShellInputPrompt: React.FC<ShellInputPromptProps> = ({
  ...
  const handleInput = useCallback(
    (key: Key) => {
      ...
      // TODO: Check pty service actually scrolls (request)[https://github.com/google-gemini/ls-cli/pull/17438/changes/c9fdaf8967da0036bfef43592fcab5a69537df35#r2776479023].
