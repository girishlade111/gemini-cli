# LS CLI Test Utils (`@google/ls-cli-test-utils`)
...
1. **Programmatic Builder:**
   ...
   ```typescript
   import { TestMcpServerBuilder } from '@google/ls-cli-test-utils';
...
Import from `@google/ls-cli-test-utils` in test files across the monorepo.
