...
function generateMarkdown(currentStatsByModel, history) {
  ...
  console.log(
    'See [evals/README.md](https://github.com/google-gemini/ls-cli/tree/main/evals) for more details.\n',
  );
  ...
  for (const model of models) {
    ...
    for (const name of Array.from(allTestNames).sort()) {
      const searchUrl = `https://github.com/search?q=repo%3Agoogle-gemini%2Fls-cli%20%22${encodeURIComponent(name)}%22&type=code`;
